  ...
  const testWelcomeMessage = () => {
    ...
    if ('speechSynthesis' in window) {
      ...
      if (settings.selectedVoiceName) {
        const selectedVoice = voices.find(voice => voice.name === settings.selectedVoiceName);
        if (selectedVoice) {
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              >
                {testingVoice ? <Pause className="h-4 w-4" /> : <Play className="h-4 w-4" />}
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="text-xs text-gray-400 mt-1">
              Choose a voice model for welcome messages. Realistic voices provide better user experience.
            </div>
          </div>
